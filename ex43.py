...
class CentralCorridor(Scene):
    def enter(self):
        print(dedent("""
            ...
            Your last mission is to get the neutron destruct bomb from the Weapons Armory,
            ...
            He's about to pull a weapon to blast you.
        """))
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                ...
                You die as the Gothon stomps on your head and eats you. You wake up shortly after only to...
            """))
            return 'death'
...
class LaserWeaponArmory(Scene):
    def enter(self):
        print(dedent("""
            ...
            Quiet, too quiet.
            You find the neutron bomb in its container.
            There's a keypad lock on the box and you need the code to
            get the bomb out. The code is 3 digits.
        """))
        ...
        if guess == code:
            ...
            print(dedent("""
                ...
                as the mechanism is fused together. Gothons blow up the ship from their ship and you die.
                You decide to sit there, and finally...
            """))
            return 'death'
...
class TheBridge(Scene):
    def enter(self):
        print(dedent("""
            ...
            They all have even uglier clown costumes than the last.
            None of them have pulled their weapons out yet, as they see the active bomb under your arm and don't want to set it off.
        """))
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                As you drop it, a Gothon shoots you right in the back, killing you.
                As you die, you see another Gothon frantically trying to disarm the bomb. You die knowing they will probably blow up when it goes off.
            """))
            return 'death'

        elif action == "slowly place the bomb":
            print(dedent("""
                You point your blaster at the bomb under your arm and the Gothons put their hands up, starting to sweat.
                You inch backward to the door, open it, and then carefully place the bomb on the floor, pointing your blaster at it.
                You punch the close button and blast the lock so the Gothons can't get out.
